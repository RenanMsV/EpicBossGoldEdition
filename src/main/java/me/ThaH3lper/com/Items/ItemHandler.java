...
public class ItemHandler
{
    ...
    public static ItemStack setPlayerName(final ItemStack item, final EpicItems ei) {
        if (item.getType().equals((Object) Material.PLAYER_WALL_HEAD) || item.getType().equals((Object)Material.PLAYER_HEAD)) {
            final SkullMeta meta = (SkullMeta)item.getItemMeta();
            //meta.setOwner(ei.player);
            meta.setOwningPlayer(Bukkit.getOfflinePlayer(ei.player));
